...
const TrackingForm: React.FC<FormProps> = ({ loggedUser, readOnlyName = false }) => {
    ...
    // SaudaÃ§Ã£o automÃ¡tica conforme o horÃ¡rio
    const getGreeting = () => {
    ...
    // FunÃ§Ã£o para formatar data de yyyy-mm-dd para dd/mm/yyyy
    ...
    // Texto com emojis (para cÃ³pia, email, preview)
